...
public class NumberUtils {
    ...
    public static String double2USD(Double value) {
        value = (null == value ? 0d : value);
        NumberFormat format = NumberFormat.getCurrencyInstance(Locale.US);
        return format.format(value);
    }

    public static String double2CNY(Double value) {
        value = (null == value ? 0d : value);
        NumberFormat format = NumberFormat.getCurrencyInstance(Locale.CHINA);
        return format.format(value);
    }

    public static Double USD2Double(String USD) {
        NumberFormat format = NumberFormat.getCurrencyInstance(Locale.US);
        try {
            return format.parse(USD).doubleValue();
    ...
    public static Double CNY2Double(String CNY) {
        NumberFormat format = NumberFormat.getCurrencyInstance(Locale.CHINA);
        try {
            return format.parse(CNY).doubleValue();
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static String format(Double number) {
        ...
        return Arith.round(number, 4).stripTrailingZeros().toPlainString();
