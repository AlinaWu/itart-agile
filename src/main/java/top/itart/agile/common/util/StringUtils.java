 ...
 * @Description: Trim string, Convert string to Integer, Double etc
 * @author hymanz (www.itart.top)
 * @version V1.0
 * @Date Dec 18, 2014 5:28:28 PM
 */
public class StringUtils {
    public static final String SYS_TIME1 = "yyyy-MM-dd HH:mm:ss";
 ...
 // Performance testing notes (JDK 1.4, Jul03, scolebourne)
                                                        ...
                                                        boolean preserveAllTokens) 
    {
        ...
        ArrayList<Object> substrings = new ArrayList<Object>();
